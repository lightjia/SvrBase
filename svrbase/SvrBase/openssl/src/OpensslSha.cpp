...
len_str COpensslSha::Sha1(const unsigned char* psrc, int iSrcLen) {
    len_str lRet;
    BZERO(lRet);
...
len_str COpensslSha::Sha224(const unsigned char* psrc, int iSrcLen) {
    len_str lRet;
    BZERO(lRet);
    ASSERT_RET_VALUE(psrc && iSrcLen > 0, lRet);
...
len_str COpensslSha::Sha256(const unsigned char* psrc, int iSrcLen) {
    len_str lRet;
    BZERO(lRet);
    ASSERT_RET_VALUE(psrc && iSrcLen > 0, lRet);
...
len_str COpensslSha::Sha384(const unsigned char* psrc, int iSrcLen) {
    len_str lRet;
    BZERO(lRet);
    ASSERT_RET_VALUE(psrc && iSrcLen > 0, lRet);
...
len_str COpensslSha::Sha512(const unsigned char* psrc, int iSrcLen) {
    len_str lRet;
    BZERO(lRet);
    ASSERT_RET_VALUE(psrc && iSrcLen > 0, lRet);
